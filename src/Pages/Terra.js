    ...
    <>
      ...
      <MainProm>
        <div data-aos="fade-up">
          <PromPageHeadText>
            ABOUT <PromHeadGreen>TERRATALKS</PromHeadGreen>
          </PromPageHeadText>
          <MainFlexDiv>
            ...
            <div>
              <PromPagepara>
              Terra talks stand out from other forms of presentations as an effective medium to convey accurate easy-to-understand information to a target audience. 
            We cannot survive without the environment, which is the backbone of our survival. To make people aware of this we invite some committed environmental leaders who are also engineers, who work to ensure that mankind preserves the desirable human-nature interaction.
              ...
              <FlexDiv>
                <CountMainDiv>
                  ...
                  <CountDiv>
                    <Count>Online Event</Count>
                    <CountDetail>On Instagram</CountDetail>
                  </CountDiv>
                </CountMainDiv>
                {/*
                <div>
